...
def show03_display_blur_response(setup: SetUp) -> None:
    """Display blur response at 4 horizontal windows."""
    ...
    for i in range(setup.frame_count):
        ...
        # Gradually increase blurriness, starting from 0 blur
...
def show04_display_threshold(setup: SetUp) -> None:
    ...
    for i in range(setup.frame_count):
        ...
        # Shrink channels by 50% (to see if better results)
        # No matter percent threshold, results did not get better/worse
...
def show09_display_farneback_dense_optical_flow(setup: SetUp) -> None:
    """Perform and display Farneback dense optical flow."""
...
def show10_display_surfer_detection(setup: SetUp) -> None:
    """Surfer detection with Canny detection and contour with image set #2."""
